...
id_ControllerSplash =		id(ptr_ControllerSplash)	; $0
id_TitleScreen =			id(ptr_Title)				; $4
id_StageSelectScreen =		id(ptr_StageSelect)			; $8
id_LevelSelectScreen =		id(ptr_LevelSelect)			; $C
id_LevelScreen =			id(ptr_Level)				; $10
