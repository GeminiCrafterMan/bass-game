...
Unknown2_ScreenEvent:
		tst.b (Screen_event_flag).w
		bne.s	Unknown2_ScreenEvent_RefreshPlane
		move.w	(Screen_shaking_flag+2).w,d0
		add.w	d0,(Camera_Y_pos_copy).w
		jmp	(DrawTilesAsYouMove).w
; ---------------------------------------------------------------------------

Unknown2_ScreenEvent_RefreshPlane:
		clr.b	(Screen_event_flag).w
		jmp	(Refresh_PlaneScreenDirect).w

; =============== S U B R O U T I N E =======================================

Unknown2_BackgroundInit:
		bsr.s	Unknown2_Deform
		jsr	(Reset_TileOffsetPositionEff).w
		jsr	(Refresh_PlaneFull).w
		bra.s	Unknown2_BackgroundEvent.deform

; =============== S U B R O U T I N E =======================================

Unknown2_BackgroundEvent:
		tst.b (Background_event_flag).w
		bne.s	Unknown2_Transition
		bsr.s	Unknown2_Deform

.deform:
		lea	Unknown2_BGDeformArray(pc),a4
