...
; BunniDev is now simply known as Kilo. Also they don't want to be bothered with anyone but whatever-
; Modified by Gemini0 to only work for player palettes
; ===========================================================================
; ---------------------------------------------------------------------------
...
updateWaterShift:
		moveq	#$10/2-1,d3		; update player colors (loop iterates through 2 colors at once)
