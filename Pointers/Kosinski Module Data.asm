...
ArtKosM_BusterShots:			binclude "Objects/Player Projectiles/KosinskiM Art/Buster Shots.bin"
	even
ArtKosM_ScorchBarrierC:			binclude "Objects/Player Projectiles/KosinskiM Art/Scorch Barrier C.bin"
	even
...
ArtKosM_Controller:				binclude "Data/Screens/Controller Splash/KosinskiM Art/Controller Splash.bin"
	even
